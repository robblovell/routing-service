...
describe 'Test Read Header', () ->
    ...
    it 'reads local configuration environment', (done) ->
        ...
        JSON.stringify(config).should.be.equal('{"neo4jurl":"bolt://neo4j:macro7@localhost","port":"3000","host":"localhost","scheme":"http","mountPoint":"file://'+base_dir+'/../data/","env":"local","internal_port":"3000","basepath":"/","version":"'+config.version+'","timeout":15000,"host_url":"localhost:3000"}')
        done()
        return
    ...
    it 'reads test configuration environment', (done) ->
        ...
        JSON.stringify(config).should.be.equal('{"neo4jurl":"bolt://develop:k3qPB4V2yxPNAivieu3B@sb10.stations.graphenedb.com:24786","port":"3000","host":"localhost","scheme":"http","mountPoint":"file://'+base_dir+'/../data/","env":"test","internal_port":"3000","basepath":"/","version":"'+config.version+'","timeout":15000,"host_url":"localhost:3000"}')
        done()
        return